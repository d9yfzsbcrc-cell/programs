...
tiempoej = float(input("Introduce el tiempo de ejecución: "))
caudal = float(input("Introduce el valor del llenado: "))
vaciado = float(input("Introduce el valor del vaciado: "))
umbral = float(input("Introduce el valor de control: "))

# Ejemplo de lectura segura para detectar que la entrada es un float
try:
    peligro = float(input("Introduce el valor de alarma: "))
